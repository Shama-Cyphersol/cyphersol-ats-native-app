...
class CashWithdrawalChart(QMainWindow):
    ...
    def create_data_table_cashWithdrawal(self, layout):
        ...
        <html>
        <head>
            <title>Cash Withdrawal Data</title>
            <style>
                * {{
                    margin: 0;
                    padding: 0;
        ...
        <body>
            <div class="table-container">
                <div class="table-header">Cash Withdrawal Data Table</div>
